package com.a.aa.config.auth;

import com.a.aa.config.auth.dto.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        P_user user = saveOrUpdate(attributes);
    ...
    private P_user saveOrUpdate(OAuthAttributes attributes) { // (5)
        P_user user = userRepository.findByEmail(attributes.getEmail())
